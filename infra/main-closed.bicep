// ============================================================
// 疑似オンプレミス環境 — パターン 2: 完全閉域 (インターネット送信ブロック)
// ============================================================
// defaultOutboundAccess: false + NSG DenyInternetOutbound により、
// VM からインターネットへの送信アクセスを完全にブロックします。
// Windows Update、GitHub、パッケージマネージャー等は使用できません。
// ============================================================
